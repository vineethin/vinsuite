  ...
  const tools = [
    {
      ...
      description: "Analyze and improve SQL queries using AI-based suggestions.",
      path: "/query-optimizer"
    },
    {
      title: "Backup Status Checker",
      description: "Review and validate daily or weekly database backups.",
      path: "/backup-check"
    },
    {
      title: "Schema Change Tracker",
      description: "Monitor and audit changes to your database schema.",
      path: "/schema-tracker"
    }
  ];
