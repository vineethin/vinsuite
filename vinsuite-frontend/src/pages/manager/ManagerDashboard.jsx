  ...
  const tools = [
    {
      ...
      description: "View test execution status, pass/fail trends, and defect stats.",
      path: "/test-results"
    },
    {
      title: "Project Summary Reports",
      description: "Download automated project health reports for stakeholders.",
      path: "/project-reports"
    },
    {
      title: "Team Allocation Board",
      description: "Visualize and manage QA/dev resource assignments.",
