...
const BADashboard = () => {
  ...
  const tools = [
    {
      title: "User Story to Test Case Mapper",
      description: "Convert user stories into detailed test scenarios.",
      path: "/story-to-test"
    },
    {
      title: "Requirement Coverage Tracker",
      description: "Ensure every requirement is linked to test cases.",
      path: "/coverage-tracker"
    },
    {
      title: "Acceptance Criteria Assistant",
      description: "AI-generated acceptance criteria suggestions.",
      path: "/criteria-assist"
    }
  ];
